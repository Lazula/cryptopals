...
int main(){
	...
	printf("Starting HMAC timing-based brute-force. This will take several minutes.\n");
	...
	for(i = 0; i < SHA1_DIGEST_SIZE; i++){
		for(j = 0; j < 256; j++){
			 ...
			 * @ 50 ms / byte.
			 * e.g. Checking the third byte will take 100ms
			 * if incorrect and 150ms when correct. */
			if(msecs_taken > (clock_t) (50 * i)){
				#if DEBUG
