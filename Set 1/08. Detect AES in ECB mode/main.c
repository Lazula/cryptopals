...
int main(int argc, char *argv[]){
	...
	unsigned char *const line_buffer = calloc(line_buffer_size, sizeof(unsigned char)), *linebreak, *raw_encrypted_data, *decrypted_data;
